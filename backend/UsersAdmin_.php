...
class UsersAdmin extends Backend
{
	...
	{	
		...
		if(!empty($move_in_out))
		{
			...
			date_add($arrive_date, date_interval_create_from_date_string('4 days'));

			$current_date = date_create(date("Y-m-d"));
			date_sub($current_date, date_interval_create_from_date_string('2 days'));
		...
		$filter['select_contract_info'] = true;
