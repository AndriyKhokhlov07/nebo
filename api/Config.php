...
class Config
{
	...
	private $vars = array();
    private static $staticVars = array();
	...
	{		
        ...
        $_SERVER['DOCUMENT_ROOT']=($localpath && $absolutepath)
            ? substr($absolutepath,0,strpos($absolutepath,$localpath))
            : '';
		...
		// Протокол
        $protocol = !empty($this->vars['protocol']) ? $this->vars['protocol'] : 'http';
