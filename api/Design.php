...
use Libs\ViewHelper\ViewPlugins;
...
class Design extends Backend
{
	...
	public function __construct()
	{
        ...
        $this->smarty->registerPlugin('function', 'route', [new ViewPlugins(), 'route_plugin']);
	...
	public function resize_modifier($filename, $type, $width=0, $height=0, $set_watermark=false, $grayscale=false)
	{
		...
		elseif($type == 'user')
			return $this->config->root_url.'/'.$this->config->resized_users_images_dir.$resized_filename_encoded;
	}
