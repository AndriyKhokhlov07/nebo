...
<p>This Lease and the riders annexed hereto, contain the agreements between You and Owner concerning Your rights and  obligations  and  the  rights  and  obligations  of  Owner. You and Owner have other rights and obligations which are set forth in government laws and regulations:</p> 
<p>You  should  read  this  Lease  and  all  of  its  attached  parts  and  the  other  documents  carefully.  If  You  have  any questions, or if You do not understand any words or statements, get clarification. Once You and Owner sign this Lease, Youand Owner will be presumed to have read it and understood it. You and Owner admit that all agreements between You and Owner have been written into this Lease and the documents indicated above. You understand that any other agreements, whether made before or after this Lease was signed, will not be enforceable.</p>
...
<ol>
	<li>The term (that means the length) of this Lease is for <strong>{$contract_info->lease_term} Months</strong> and commences on <strong>{$contract_info->date_from|date}</strong> and ends on <strong>{$contract_info->date_to|date}</strong>, except that, if You do not do everything You agree to do in this Lease, Owner may have the right to end this Lease before the above date. </li>
</ol>
...
<p><strong>CHECK ONE</strong></p>
<ul>
	<li><input type="radio" id="children1" name="children" class="agree" value="1"><label id="block_children1" for="children1">CHILDREN 10 YEARS OF AGE OR YOUNGER LIVE IN MY APARTMENT</label> </li>
	<li><input type="radio" id="children2" name="children" checked class="agree" value="2"><label id="block_children2" for="children2">NO CHILDREN 10 YEARS OF AGE OR YOUNGER LIVE IN MY APARTMENT</label></li>
	<li><input type="radio" id="children3" name="children" class="agree" value="3"><label id="block_children3" for="children3">I WANT WINDOW GUARDS EVEN THOUGH I HAVE NO CHILDREN 10 YEARS OF AGE OR YOUNGER</label></li>
</ul>
