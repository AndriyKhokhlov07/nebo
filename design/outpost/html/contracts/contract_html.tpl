...
<p>The New Roommate agrees to pay in rent the amount of {$contract_info->price_month|convert} (US Dollars) due on the <strong>1 of every month</strong>.</p> 
{* {(strtotime($invoice_first->date_from|date)-(10*24*60*60))|date_format:'%e'} *}
