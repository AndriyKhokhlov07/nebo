...
{if $contract_info->room_type!=0}
	...
	{/if}
{/if}
from <strong>{$contract_info->date_from|date}</strong>, at 3 pm EST until <strong>{$contract_info->date_to|date}</strong>, at 11 am EST, and unrestricted access to all the
...
<h2>Security Deposit, Security Deposit Payment Schedule, and HelloRented Inc. Security Deposits</h2>
<p>For good and valuable consideration, the sufficiency of which is acknowledged, the parties to this Agreement who have signed at the bottom of this document hereby agree as follows:</p>
<ol>
...
<p>For good and valuable consideration, the sufficiency of which is acknowledged, the parties to this Agreement who have signed at the bottom of this document hereby agree as follows:</p>
<ol>
<li>The Member agrees to pay an Annual Membership Payment of {if $contract_info->membership==1}699 USD for Gold{elseif $contract_info->membership==2}29 USD for Silver{/if} Membership, giving them access to all benefits and agreeing to all the conditions outlined in Appendix 1 for one year, starting from the Arrival Date (Clause 3).</li>
</ol>
{/if}
...
<p>For good and valuable consideration, the sufficiency of which is acknowledged, the parties to this Agreement who have signed at the bottom of this document hereby agree as follows:</p>
<ol>
<li>In case the Payment is not received timely, before the date indicated in Clause 7, a Late Payment Fine of 50 USD per day would be applied. If the member’s payment is late by
...
<li>The Member may not cancel or pause their stay before the end of the contract term.</li>
...
amount of days on future stays at any properties of Outpost Club (hereinafter
referred to as “the Credit” or “this Credit”). This Credit will expire one year after
the notice of cancellation.</li>
...
the Member is entitled the following:</li>
<ol>
<li>In the case that cancellation is more than 30 days in advance of the Member’s
move-in date, the Member will receive a 100% full refund from Outpost Club.
This includes both the Member’s First Monthly Membership Fee (Clause 5) and
...
Club has already received the entirety of the Member’s first month’s fee and the
Member’s Security Deposit.</li>
...
Club property, the Member’s Guests agree to abide the Club Rules, while Member
...
<p>Outpost Club Members who have signed a Silver or Bronze Membership Agreement are
granted access to the following:</p>
...
<p>In addition to the above, Outpost Club Members who have signed a Silver or Bronze Membership Agreement agree to the following:</p>
<ol>
<li>The Member has access to only the Outpost Club House for which they signed a
Membership agreement, except to attend Outpost Club events or visit other Club
Members.</li>
<li>The Member may have an overnight guest on Club property during quiet hours (10 p.m. - 9 a.m.) only by paying a $30 per night fee. The Member is limited to one overnight guest at a time for no longer than two consecutive days. Outpost Club can only provide the option of accomodating a paid guest if Outpost Club has a room or bed for the guest.</li>
<li>The Member may not cancel or pause their stay before the end of the contract term.</li>
...
<li>The Member will let the cleaners enter bedroom for a weekly cleaning of the floor. For the cleaning days, you must organize your personal belongings in a way that allows the cleaners to mop and sweep the floor.</li>
</ol>
