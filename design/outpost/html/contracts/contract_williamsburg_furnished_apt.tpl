	...
	<li>
		...
		<ol>
			<li>
				...
				<p>The Tenant(s) agree to an additional $0.00 monthly fee renting the apartment "Furnished". The "Furnished" rental fee will be billed along with the monthly rent and utility fee through the Appfolio tenant portal. Please see the attached INVENTORY LIST for what is included in the rental. The Landlord retains the right to charge the tenant for damage to any item listed on the inventory list and tenant agrees to pay for any such damage as per the attached FEE CATALOG. The charges will be added to the tenant's ledger and tenant agrees to pay the charges as additional rent through the Appfolio tenant portal.</p>
			</li>
			<li>
...
{elseif $contract_info->signature2}
	...
	{*
	<li>
		<h1>FURNISHED - Inventory list</h1>
	...
	*}
	...
	<li>
 	...
 	<li>
 		...
 		<p>By initialing below, you acknowledge and agree to the terms in Section 8.</p>
	...
	<li>
		...
		<p>By initialing below, you acknowledge and agree to the terms in Section 10.</p>
		{foreach $contract_users as $user}
			{if $user->id != $contract_user->id}
				<p>TENANT NAME: {$user->name|escape}<br/>
				{if $user->log}
