...
{$javascripts[]="design/`$settings->theme`/js/user_check.js?v1.0.6" scope=parent}
...
{/if}
		...
		<div class="company_header">
			...
			<div class="cont">
				<p>Outpost Club Inc and The Lichy Group Inc are part of Outpost Group, which provides property management services in the states of New York, New Jersey and California. Should you have any questions, please feel free to call <a href="tel:+18337076611" target="_blank">+1 (833) 707-6611</a> or email <a href="mailto:info@outpost-club.com" target="_blank">info@outpost-club.com</a></p>
				<p>The registered address of Outpost Club Inc is 5105 Flushing Ave, Maspeth, NY 11378, office 301<br>
				The registered address of The Lichy Group Inc is 222 East 68th Street, New York, NY, 10065</p>
		...
		{if $invoice___}
			...
			<div class="steps_sell">
			  ...
			  <div class="item">
			    ...
			    <img src="design/{$settings->theme|escape}/images/icons/invoice.svg" alt="invoice">
				<p class="title">Deposit by HelloRented</p>
			  </div>
			</div>
			{/if}
		</div>
