...
{$javascripts[]="design/`$settings->theme`/js/user_check.js?v1.0.16" scope=parent}
...
{/if}
    ...
    {/if}
	{if ($smarty.get.success=='sended' && ($contract->interval < 28 || ($user->us_citizen == 2 && $contract->interval < 90) )) || $smarty.get.add_docs=='sended'}
				<div class="info">
	...
	{elseif $smarty.get.success=='sended' && $contract->interval >= 28}
				...
				<div class="content_block1 visible v1">
						...
						<div class="input_block">
							<div class="fx ch2">
								...
								<div class="fx ch2_1">
									<div class="input_wrapper">
										...
										<input class="inp_i required" id="street_address" type="text" name="street_address" value="{$salesflow->application_data['street_address']|escape}" placeholder="" data-required data-pattern="{literal}[A-Za-z0-9\s\.\-\(\)'`,]{3,}{/literal}">
									</div>
							...
							<div class="fx ch3">
								...
								<div class="input_wrapper">
									...
									<input class="inp_i{if $user->us_citizen!=2} required{/if}" id="current_landlord_address" type="text" name="blocks[cl_address]" value="{$salesflow->application_data['cl_address']|escape}" placeholder="" data-required>
								</div>
							...
							<div class="fx ch2">
								...
								<div class="fx ch2_1">
									<div class="input_wrapper">
										...
										<input class="inp_i{if $user->us_citizen!=2} required{/if}" id="previous_address" type="text" name="blocks[prev_address]" value="{$salesflow->application_data['prev_address']|escape}" placeholder="" data-required>
									</div>
							...
							<div class="fx ch3">
								...
								<div class="input_wrapper">
									...
									<input class="inp_i{if $user->us_citizen!=2} required{/if}" id="previous_landlord_address" type="text" name="blocks[pl_address]" value="{$salesflow->application_data['pl_address']|escape}" placeholder="" data-required>
								</div>
					...
					<div class="padd_bx">
						<div class="input_block">
							...
							{if (($contract->interval < 90 && $contract->reserv->type == 1) || !$contract) && $user_type=='tenant'}
							{else}
							<div class="fx ch2">
								<div class="input_wrapper">
