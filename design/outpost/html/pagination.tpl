...
<div class="pagination">
	...
	{if $current_page_num==2}<a class="prev_page_link{if $current_page_num==$total_pages_num} v{/if}" href="{url page=null}">←prev</a>{/if}
	{if $current_page_num>2}<a class="prev_page_link{if $current_page_num==$total_pages_num} v{/if}"" href="{url page=$current_page_num-1}">←prev</a>{/if}
	{if $current_page_num<$total_pages_num}<a class="next_page_link{if $current_page_num<2} v{/if}" href="{url page=$current_page_num+1}">next→</a>{/if}
