...
<head>
    ...
    <link href="design/{$settings->theme|escape}/css/contracts.css?v1.0.19" rel="stylesheet">
...
{/if}
	...
	{else}
		<form class="signature_form" name="covid_form" method="POST" enctype="multipart/form-data">

			<div class="check_wrapper">

				{include file='covid_form_html.tpl'}
...
document.getElementById('save').addEventListener('click', function () {
	    ...
	    document.forms["covid_form"].submit();
});
