    ...
    <div class="w1300">
        ...
        {function name=month_ln}
            {if $m}
                ...
                <td></td>
                <td>
                    <div class="tenants_name"{if $b->users|count>1} title="{$b->users_names}"{/if}>
                        {$b->users_names}
                    </div>
                </td>
                ...
                {foreach $apartments as $a}
                    ...
                    {if !$a->a_bookings && !$a->b_bookings}
                        ...
                        <tr>
                            ...
                            <td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                            <td class="ll"></td>
                            {f_booking b=$a->feature_a_booking}
                        </tr>
                        <tr class="tr_total">
                            <td></td><td></td><td></td>
                            <td>$ {$a->price}</td>
                        ...
                        {if $a->isset_feature_b_bookings}
                            ...
                            {foreach $a->beds as $bed}
                                ...
                                <tr>
                                    ...
                                    <td colspan="7"></td>
                                    <td class="ll"></td>
                                    {f_booking b=$bed->feature_b_booking}
                                </tr>
                            {/foreach}
                            <tr class="tr_total">
                                <td></td><td></td><td></td>
                            ...
                            *}
                            ...
                            {if $a->b_bookings && $a->b_current_count>0}
                                ...
                                <tr class="tr_total">
                                    ...
                                    <td></td>
                                    <td>
                                        {if $a->month1_b_total_rent_gross}
                                            $ {$a->month1_b_total_rent_gross}
                                        {/if}
                                    </td>
                                    <td>
                                        {if $a->month1_b_total_utility_price}
                                            $ {$a->month1_b_total_utility_price}
                                        {/if}
                                    </td>
                                    <td></td><td></td><td></td><td></td>
                                    <td class="ll"></td>
                            ...
                            {elseif $a->isset_feature_b_bookings}
                                {$bed_n=0}
                                {foreach $a->beds as $bed}
                                    {$bed_n=$bed_n+1}
                                    <tr>
