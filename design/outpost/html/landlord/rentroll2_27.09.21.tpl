        ...
        <div class="table_r">
            <table>
                <tr class="tr_h">
                    ...
                    <td class="ll"></td>
                    <td colspan="7">Monthly invoice</td>
                    {*
                    <td class="ll"></td>
                ...
                <tr class="tr_gtotal">
                    ...
                    <td class="td_price">
                        {if $params->grand_total->price_month_income}
                            $ {$params->grand_total->price_month_income|round}
                        {/if}
                    </td>
                    <td class="td_price">
                        {if $params->grand_total->price_rent_month}
                            $ {$params->grand_total->price_rent_month|round}
                        {/if}
                    </td>
                    <td class="td_price">
                    ...
                    *}
                    <td class="td_price">
                        {if $params->grand_total->price_invoices}
                            $ {$params->grand_total->price_invoices|round}
                        {/if}
                    </td>
                    <td class="td_price">
                        {if $params->grand_total->price_paid_invoices}
                            $ {$params->grand_total->price_paid_invoices|round}
                        {/if}
                    </td>
                    <td></td>
                    {*
                    <td class="td_price">
                        {if $params->grand_total->broker_fee}
                            $ {$params->grand_total->broker_fee|round}
                        {/if}
                    </td>
                    <td></td>
                    <td class="td_price broker_fee_result_bx">
                        {if $params->grand_total->broker_fee_paid}
                            $ <span>{$params->grand_total->broker_fee_paid|round}</span>
                        {/if}
                    </td>
                    <td colspan="3"></td>
                    *}
                    ...
                    <table>
                        ...
                        {if $params->other_period_total->price_paid}
                            <tr class="rs_other_period">
                                <td>Invoices Paid (Cash) Other Period</td>
                ...
                <table class="other_period_table">
                    ...
                    <td class="td_price">
                        {if $params->other_period_total->price}
                            $ {$params->other_period_total->price|round}
                        {/if}
                    </td>
                    <td class="td_price">
                        {if $params->other_period_total->price_paid}
                            $ {$params->other_period_total->price_paid|round}
                        {/if}
                    </td>
                    <td></td>
                    {*
                    ...
                    <td></td>
                    <td class="td_price">
                        {if $params->other_period_total->broker_fee}
                            $ <span>{$params->other_period_total->broker_fee|round}</span>
                        {/if}
                    </td>
                    ...
                    <td class="td_price broker_fee_result_bx">
                        {if $params->other_period_total->broker_fee_paid}
                            $ <span>{$params->other_period_total->broker_fee_paid|round}</span>
                        {/if}
                    </td>
        ...
        {if $debt_invoices}
            ...
            <div class="table_r">
               <table>
                    ...
                    {foreach $debt_invoices as $i}
                        <tr>
                            ...
                            {elseif $i->booking->type==2}
                                <td class="td_price">Full apt</td>
                            {/if}
                            {tr i=$i show_price=1 show_unpaid=1 hide_bf_to=1 is_debt=1}
                        </tr>
                    {/foreach}
                    ...
                    <td class="td_price">
                        {if $params->debt_invoices->price}
                            $ {$params->debt_invoices->price|round}
                        {/if}
                    </td>
                    <td class="td_price">
