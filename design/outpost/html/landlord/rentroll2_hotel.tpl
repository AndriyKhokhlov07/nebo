...
{function name=tr}
    ...
    <!-- Nights count -->
    <td>{if $i->booking->nights_count > 0}
            {$i->booking->nights_count}
        {/if}</td>
    ...
    *}
    ...
    <!-- Av. rent per night -->
    <td class="td_price">{if $i->booking && $i->booking->price_night>0}
            $ {$i->booking->price_night|number_format:2:'.':''}
        {/if}</td>
    ...
    <div id="print_bx">
        ...
        <div class="table_r">
            <table>
                ...
                <tr><td class="bl" colspan="17"></td></tr>
                ...
                <tr class="tr_gtotal">
                    ...
                    <td colspan="7"></td>
                    <td class="td_price">
                        {if $data->grand_total->anr_adv}
                            $ {$data->grand_total->anr_adv|number_format:2:'.':''}
                        {/if}
                    </td>
                    <td colspan="4"></td>
                    ...
                    *}
                    ...
                    <td class="td_price">
                        {if $data->grand_total->broker_fee}
                            $ {$data->grand_total->broker_fee|round}
                        {/if}
                    </td>
                    <td></td>
                    <td class="td_price broker_fee_result_bx">
                        {if $data->grand_total->broker_fee_paid}
                            $ <span>{$data->grand_total->broker_fee_paid|round}</span>
                        {/if}
                    </td>
                    <td colspan="3"></td>
                    *}
                    ...
                    <table>
                        ...
                        {if $data->grand_total->purchases_price || $data->other_period->purchases_price}
                            ...
                            {if $data->grand_total->purchases_price}
                                <tr>
                                    ...
                                    <td class="val">$ <span class="sum">{($data->grand_total->purchases_price|round:2)|convert}</span></td>
                                </tr>
                            {/if}
                            {if $data->other_period->purchases_price}
                                <tr>
                                    <td>Thereof rent Rent Prepaid</td>
                                    <td class="val">$ <span class="sum">{($data->other_period->purchases_price|round:2)|convert}</span></td>
                                </tr>
                            {/if}
                            <tr class="ll">
                                <td colspan="2"></td>
                        ...
                        {if $data->grand_total->utilites_price || $data->other_period->utilites_price}
                            ...
                            {if $data->grand_total->utilites_price}
                                <tr>
                                    ...
                                    <td class="val">$ <span class="sum">{$data->grand_total->utilites_price|convert}</span></td>
                                </tr>
                            {/if}
                        ...
                        *}
                        ...
                        {if $data->grand_total->anr_adv}
                            <tr>
                                <td>ADR</td>
                                <td class="val">$ {$data->grand_total->anr_adv|number_format:2:'.':''}</td>
                            </tr>
                        {/if}
                    ...
                    <div class="table_r ts1">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="val">$ {$data->grand_total->price_paid_invoices|round:2|convert}</td>
                            </tr>
                            {/if}
                            {if $data->past_paid}
                                {foreach $data->past_paid as $d=>$v}
                                    <tr>
                                        ...
                                        {*<td>{$v->amount}</td>*}
                                        <td class="val">$ {$v->total_price|round:2|convert}</td>
                                    </tr>
                                {/foreach}
        ...
        {if $other_period_invoices}
            ...
            <div class="table_r">
                <table class="other_period_table">
                    ...
                    <tr><td class="bl" colspan="16"></td></tr>
