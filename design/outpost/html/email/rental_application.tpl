{* Rental Application email template for customer *}
{$subject = "{$settings->company_name|escape} | Rental Application" scope=parent}
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" style="background:#fff; border-radius: 5px; width:100%; box-shadow: 0 3px 15px rgba(0,0,0,.15);">
				...
				<tr>
					<td colspan="4" style="padding: 20px 30px 20px;">
						...
						<a style="display:block; border-radius: 7px; background:#008f35; color:#fff; font:500 20px/1 Helvetica; text-align:center; text-transform:uppercase; text-decoration: none; padding: 17px 10px 15px; margin: 0 0 15px;" href="{$config->root_url}/user/rental_application/{$user->auth_code}">To Rental Application</a>
					</td>
				</tr>
			</table>
		</td>
