...
{$subject = "Sign up for Sure Renters Insurance for your stay at Outpost Club" scope=parent}
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" style="background:#fff; border-radius: 5px; width:100%; box-shadow: 0 3px 15px rgba(0,0,0,.15);">
				<tr>
					<td colspan="4" style="padding: 40px 30px 20px;">
						<p style="color:#333; font: 500 26px/1 Helvetica; margin:0 0 15px;">Hey there, {$user->first_name}</p>
						<p style="color:#333; font: 100 16px/1.3 Helvetica; margin:0 0 15px;">Outpost Club requires its new members to have renters insurance. Outpost partners with Sure, a renters insurance provider to make the process quick and easy. Once you sign up, this inexpensive service will follow you to all your future apartments.</p>
					</td>
				</tr>
				<tr>
					<td colspan="4" style="padding: 20px 30px 20px;">
						
						<a style="display:block; border-radius: 7px; background:#008f35; color:#fff; font:500 20px/1 Helvetica; text-align:center; text-transform:uppercase; text-decoration: none; padding: 17px 10px 15px; margin: 0 0 15px;" href="{$config->root_url}/user/sure/{$sure->url}">Get Started</a>
					</td>
				</tr>
			</table>
		</td>
