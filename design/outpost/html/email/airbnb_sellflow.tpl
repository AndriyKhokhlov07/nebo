					...
					<td colspan="4" style="padding: 40px 30px 20px;">
						...
						{if $interval_days < 30}
							...
							<ol>
								...
								<li style="color:#333; font: 100 14px/1.1 Helvetica; margin:0 0 7px;">We will request a photo of the ID of each person that moves into the apartment/room</li>
							</ol>
						{else}
							...
							<ol>
								...
								{if $salesflow->type == 3} {* hotel *}
									<li style="color:#333; font: 100 14px/1.1 Helvetica; margin:0 0 7px;">Pay Occupancy Tax $2.00/day and NYS Javits Tax $1.50</li>
								{/if}
								<li style="color:#333; font: 100 14px/1.1 Helvetica; margin:0 0 7px;"><strong>Sign your lease agreement:</strong> please review your lease agreement and sign where indicated.</li>
