...
{$subject = "{$settings->company_name|escape} | Authorization for background check" scope=parent}
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" style="background:#fff; border-radius: 5px; width:100%; box-shadow: 0 3px 15px rgba(0,0,0,.15);">
				<tr>
					<td colspan="4" style="padding: 40px 30px 20px;">
						...
						<p style="color:#333; font: 100 16px/1.3 Helvetica; margin:0 0 15px;">We perform background checks on prospective residents to make sure everyone who chooses to live with us gets the best and safest experience possible.</p>
					</td>
				</tr>
				<tr>
					<td colspan="4" style="padding: 20px 30px 20px;">
						
						<a style="display:block; border-radius: 7px; background:#008f35; color:#fff; font:500 20px/1 Helvetica; text-align:center; text-transform:uppercase; text-decoration: none; padding: 17px 10px 15px; margin: 0 0 15px;" href="{$config->root_url}/user/check/{$notification->url}">Authorization for background check</a>
					</td>
				</tr>
			</table>
		</td>
