{* Urgent: Payment Reminder and Late Payment Fee Notice *}

{$subject = "Urgent: Payment Reminder and Late Payment Fee Notice" scope=parent}
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" style="background:#fff; border-radius: 5px; width:100%; box-shadow: 0 3px 15px rgba(0,0,0,.15);">
				<tr>
					<td colspan="4" style="padding: 40px 30px 20px;">
						...
						<p style="color:#333; font: 100 14px/1.2 Helvetica; margin:0 0 7px;">We hope this email finds you well. We are writing to inform you that we have not yet received the payment for the upcoming rental period. It is essential to settle this payment promptly to ensure the seamless continuation of your tenancy.</p>
						<p style="color:#333; font: 100 14px/1.2 Helvetica; margin:0 0 7px;">To facilitate the payment process, we have prepared an invoice for the outstanding amount, including the rent for the specified period. You can conveniently make the payment by clicking on the following link: <a href="{$config->root_url}/order/{$order->url}?u={$user->id}&w=1&pm=a" target="_blank">{$config->root_url}/order/{$order->url}?u={$user->id}&w=1&pm=a</a>.</p>
						<p style="color:#333; font: 100 14px/1.2 Helvetica; margin:0 0 7px;">We kindly request you to review the invoice carefully as it now includes the late payment fee that has been added.</p>
						<p style="color:#333; font: 100 14px/1.2 Helvetica; margin:0 0 7px;">Please be aware that due to the delayed payment, a late payment fee has been applied to the outstanding balance. It is important to settle the payment, including the late payment fee, to avoid further complications.</p>
						<p style="color:#333; font: 100 14px/1.2 Helvetica; margin:0 0 7px;">If you are experiencing any difficulties or have any concerns regarding the payment process or the added late payment fee, please do not hesitate to contact our office. We are here to assist you and find a suitable solution.</p>
						<p style="color:#333; font: 100 14px/1.2 Helvetica; margin:0 0 60px;">Thank you for your cooperation. We trust that you will take the necessary steps to settle the outstanding balance promptly to avoid any further inconvenience.</p>
